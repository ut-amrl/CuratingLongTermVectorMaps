...
vector<Vector2f> pointcloud_helpers::LaserScanToPointCloud(
  ...
  return pointcloud_helpers::LaserScanToPointCloud(
      laser_scan, max_range, truncate_ends, Vector2f(0, 0),
      Matrix2f::Identity());
}

vector<Vector2f> pointcloud_helpers::LaserScanToPointCloud(
    sensor_msgs::LaserScan &laser_scan, double max_range, bool truncate_ends,
    Vector2f offset, Matrix2f rotation) {
...
vector<Vector2f> pointcloud_helpers::RosCloudToPointCloud(
